<template>
  <div id="InfoFooter" :class="{ mobile:  $store.state.style.screenWidth < 1100 , desktop: $store.state.style.screenWidth >= 1100}">
    <div class="container">
      <!-- <toy/> -->
      <div class="block">
        <toy/>
      ...
      <div class="block">
        <div class="title">
          <icon-link-three theme="outline" :strokeWidth="3"/>
          <!-- <icon-cube-three theme="outline"  :strokeWidth="3"/> -->
